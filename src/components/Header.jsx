const Header = () => {
  return (
     <header className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="sm:p-10 flex justify-center items-center flex-col gap-2 sm:gap-5">
          <div className="sm:text-3xl text-xl font-bold text-gray-700">Hi I'm</div>
          <div className="sm:text-6xl text-2xl font-bold text-gray-900">Akshay,</div>
          <div className="sm:text-3xl text-xl font-bold text-gray-700">
          ...
          <div className="flex gap-2 sm:gap-3">
            ...
            <button
              className="bg-gray-700 text-white hover:bg-gray-900
                                  px-3 sm:px-6 p-2 sm:p-3 rounded-full transition transform"
            >
              Contact Info
            </button>
          </div>
