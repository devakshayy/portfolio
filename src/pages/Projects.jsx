...
const Projects = () => {
  return (
      <div className=" p-10 sm:p-10 text-center" id='projects'>
        <div className="text-gray-500 text-sm sm:text-lg dark:text-gray-400">Browse my recent</div>
        <div className="text-gray-900 text-4xl sm:text-5xl dark:text-gray-200 font-bold">Projects</div>
        <div className="grid grid-cols-1 lg:grid-cols-3 py-6 gap-6 sm:gap-10">
          <div className="card-hover dark:bg-gray-200 rounded-3xl p-4 sm:p-5 flex flex-col justify-evenly gap-2 sm:gap-10 ">
