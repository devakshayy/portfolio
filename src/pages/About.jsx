const About = () => {
  return (
    ...
    <div className="text-gray-500 dark:text-gray-400 text-sm sm:text-lg">Get to know</div>
    <div className="text-gray-900 text-2xl sm:text-5xl pb-4 font-bold dark:text-gray-200">About Me</div>
    <div className="flex flex-col lg:flex-row lg:justify-start lg:items-center gap-5 lg:gap-10 py-2">
      ...
      <div className=" py-10 flex flex-col gap-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className=" card-hover dark:bg-gray-200 rounded-3xl p-10 flex flex-col gap-3 justify-center items-center">
