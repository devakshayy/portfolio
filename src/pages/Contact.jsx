...
const Contact = () => {
  ...
  return (
    <div
      className="about sm:p-10 text-center space-y-6 p-8 relative"
      id="contact"
    >
      ...
      <div className="bg-white dark:bg-gray-300 shadow-2xl rounded-3xl p-4 lg:p-16 flex flex-col lg:flex-row lg:justify-between sm:gap-8 gap-8 items-start">
        <a href="mailto:devakshay916@gmail.com" className="no-underline">
          <div className="flex items-center">
            <img src="/email.png" alt="email" className="h-8 sm:h-11" />
            <div className="text-base sm:text-xl font-semibold hover:text-red-700 transition">
      ...
      <div className="text-xl flex flex-col gap-4 text-gray-600 p-10">
        <div className="flex items-center justify-center gap-4 lg:gap-6">
          <a href="https://x.com/dev_akshayy">
            <div className="group">
              <svg
                className=" hover:text-white group-hover:fill-current dark:group-hover:fill-white  group-hover:text-gray-400 w-7 lg:w-10"
        ...
        <div className="dark:text-gray-400 text-xs lg:text-sm ">
          Copyright <b>©</b>{" "}
        ...
        <button
          onClick={topScroll}
          className="right-6 lg:bottom-[125px] lg:right-10 bottom-16 cursor-pointer 
