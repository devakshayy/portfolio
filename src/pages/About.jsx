const About = () => {
  return (
    <div className="about p-7 lg:p-10  text-center" id="about">
    <div className="text-gray-500 text-lg">Get to know</div>
    <div className="text-gray-900 text-5xl pb-4 font-bold">About Me</div>
    <div className="flex flex-col lg:flex-row lg:justify-start lg:items-center gap-5 lg:gap-10 py-2">
      ...
      <div className=" py-10 flex flex-col gap-10">
        ...
        <div className="text text-start text-2xl text-gray-600">
          Lorem ipsum dolor sit amet consectetur adipisicing elit.Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati aspernatur et est soluta, error  Obcaecati aspernatur et est soluta, error 
        </div>
      </div>
    </div>
  </div>
